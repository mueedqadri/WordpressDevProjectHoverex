...
function registerPlugin(name, settings) {
  ...
  if (!Object(lodash__WEBPACK_IMPORTED_MODULE_4__["isFunction"])(settings.render)) {
  ...
  plugins[name] = _objectSpread({
    name: name,
    icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_3__["plugins"]
  }, settings);
...
var PluginArea = /*#__PURE__*/function (_Component) {
  Object(_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_3__["default"])(PluginArea, _Component);
  ...
  function PluginArea() {
    ...
    _this.setPlugins = _this.setPlugins.bind(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this));
