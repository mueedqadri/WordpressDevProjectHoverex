...
function rendererPath(block) {
  ...
  return Object(_wordpress_url__WEBPACK_IMPORTED_MODULE_11__["addQueryArgs"])("/wp/v2/block-renderer/".concat(block), _objectSpread(_objectSpread({
    context: 'edit'
  }, null !== attributes ? {
...
var ServerSideRender = /*#__PURE__*/function (_Component) {
  Object(_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_3__["default"])(ServerSideRender, _Component);
...
ServerSideRender.defaultProps = {
  ...
  ErrorResponsePlaceholder: function ErrorResponsePlaceholder(_ref2) {
    ...
    var errorMessage = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["sprintf"])( // translators: %s: error message describing the problem
    Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Error loading block: %s'), response.errorMsg);
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__["Placeholder"], {
      className: className
    }, errorMessage);
  },
