...
/******/ 	return __webpack_require__(__webpack_require__.s = "./node_modules/@wordpress/keyboard-shortcuts/build-module/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
function useShortcut(name, callback, options) {
  var shortcuts = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_0__["useSelect"])(function (select) {
    return select('core/keyboard-shortcuts').getAllShortcutRawKeyCombinations(name);
  }, [name]);
  Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__["useKeyboardShortcut"])(shortcuts, callback, options);
}

/* harmony default export */ __webpack_exports__["default"] = (useShortcut);
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_0__["registerStore"])('core/keyboard-shortcuts', {
...
function reducer() {
  ...
  switch (action.type) {
    case 'REGISTER_SHORTCUT':
      return _objectSpread(_objectSpread({}, state), {}, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, action.name, {
    ...
    case 'UNREGISTER_SHORTCUT':
      return Object(lodash__WEBPACK_IMPORTED_MODULE_1__["omit"])(state, action.name);
  }
...
/*!************************************************************************************!*\
  !*** ./node_modules/@wordpress/keyboard-shortcuts/build-module/store/selectors.js ***!
  \************************************************************************************/
/*! exports provided: getShortcutKeyCombination, getShortcutRepresentation, getShortcutDescription, getShortcutAliases, getAllShortcutRawKeyCombinations, getCategoryShortcuts */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var FORMATTING_METHODS = {
  display: _wordpress_keycodes__WEBPACK_IMPORTED_MODULE_4__["displayShortcut"],
  raw: _wordpress_keycodes__WEBPACK_IMPORTED_MODULE_4__["rawShortcut"],
  ariaLabel: _wordpress_keycodes__WEBPACK_IMPORTED_MODULE_4__["shortcutAriaLabel"]
};
/**
...
var getAllShortcutRawKeyCombinations = Object(rememo__WEBPACK_IMPORTED_MODULE_2__["default"])(function (state, name) {
  return Object(lodash__WEBPACK_IMPORTED_MODULE_3__["compact"])([getKeyCombinationRepresentation(getShortcutKeyCombination(state, name), 'raw')].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(getShortcutAliases(state, name).map(function (combination) {
...
var getCategoryShortcuts = Object(rememo__WEBPACK_IMPORTED_MODULE_2__["default"])(function (state, categoryName) {
  return Object.entries(state).filter(function (_ref) {
    ...
    var _ref4 = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_ref3, 1),
        name = _ref4[0];
